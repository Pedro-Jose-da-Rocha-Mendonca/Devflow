...
class TestAgentHandoff:
    ...
    def test_generate_handoff(self, mock_handoff_dirs):
        ...
        handoff = generator.generate(
            from_agent="SM",
            to_agent="DEV",
            work_summary="Created story context"
        )
...
class TestSwarmOrchestrator:
    ...
    def test_swarm_config_defaults(self):
        ...
        from lib.swarm_orchestrator import SwarmConfig, ConsensusType
    ...
    def test_check_consensus_unanimous(self, mock_swarm_env):
        ...
        from lib.swarm_orchestrator import (
            SwarmOrchestrator, SwarmConfig, ConsensusType, AgentResponse
        )
...
class TestPairProgramming:
    ...
    def test_parse_dev_output(self, mock_pair_env):
        ...
        from lib.pair_programming import PairSession, ChunkType
    ...
    def test_parse_reviewer_output_approve(self, mock_pair_env):
        ...
        from lib.pair_programming import PairSession, FeedbackType
    ...
    def test_has_blocking_issues(self, mock_pair_env):
        ...
        from lib.pair_programming import ReviewFeedback, FeedbackType
...
class TestCollaborationIntegration:
    ...
    def test_full_workflow_simulation(self, mock_full_env):
        ...
        handoff = handoff_gen.generate(
            from_agent="SM",
            to_agent="DEV",
            work_summary="Ready for implementation"
        )
    ...
    def test_knowledge_query_across_agents(self, mock_full_env):
        ...
        from lib.shared_memory import get_knowledge_graph, record_decision, query_knowledge
