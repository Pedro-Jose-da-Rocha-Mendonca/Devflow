...
try:
    ...
    from agent_handoff import HandoffGenerator, create_handoff
    from agent_router import AgentRouter, RoutingResult
except ImportError:
    ...
    from lib.agent_router import AgentRouter, RoutingResult
...
# Import re for regex (needed by _extract methods)
import re
